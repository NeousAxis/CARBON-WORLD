...
_RAW_RULES: list[tuple[str, str]] = [
    ...
    # ---- Generic catch-all "<Country>:" prefix or strong " in <X> " match ----
    # These are last because they can match too broadly otherwise. The ^
    # anchors mean: only when the title literally starts with "Country: ..."
    (r"^Kenya\b[:,]|\bin Kenya\b", "Kenya"),
    (r"^Ethiopia\b[:,]|\bin Ethiopia\b", "Ethiopia"),
    (r"^Sudan\b[:,]|\bin Sudan\b", "Sudan"),
    (r"^Egypt\b[:,]|\bin Egypt\b", "Egypt"),
    (r"^Nigeria\b[:,]|\bin Nigeria\b", "Nigeria"),
    (r"^Ghana\b[:,]|\bin Ghana\b", "Ghana"),
    (r"^Uganda\b[:,]|\bin Uganda\b", "Uganda"),
    (r"^Zimbabwe\b[:,]|\bin Zimbabwe\b", "Zimbabwe"),
    (r"^Madagascar\b[:,]|\bin Madagascar\b", "Madagascar"),
    (r"^India\b[:,]|\bin India\b", "India"),
    (r"^Pakistan\b[:,]|\bin Pakistan\b", "Pakistan"),
    (r"^Indonesia\b[:,]|\bin Indonesia\b", "Indonesia"),
    (r"^Australia\b[:,]|\bin Australia\b", "Australia"),
    (r"^Japan\b[:,]|\bin Japan\b", "Japan"),
    (r"^Brazil\b[:,]|\bin Brazil\b", "Brazil"),
    (r"^Argentina\b[:,]|\bin Argentina\b", "Argentina"),
    (r"^Mexico\b[:,]|\bin Mexico\b", "Mexico"),
    (r"^Chile\b[:,]|\bin Chile\b", "Chile"),
    (r"^Colombia\b[:,]|\bin Colombia\b", "Colombia"),
    (r"^Iran\b[:,]|\bin Iran\b", "Iran"),
    (r"^Israel\b[:,]|\bin Israel\b", "Israel"),
    (r"^China\b[:,]|\bin China\b", "China"),
    (r"^Russia\b[:,]|\bin Russia\b", "Russia"),
    (r"^Ukraine\b[:,]|\bin Ukraine\b", "Ukraine"),
]
